...
_슬라이드 3: Bob을 통한 Multi-hop Payment_
...
_슬라이드 6: 복권 비유로 이해하는 Pre-image_
...
_슬라이드 8: Charlie가 Pre-image 생성_
...
_슬라이드 10: Bob-Charlie 채널의 HTLC_
...
_슬라이드 12: Charlie → Bob으로 Pre-image 공개_
...
_슬라이드 13: Bob → Alice로 Pre-image 전파_
...
_슬라이드 15: Bob-Charlie 채널 timeout_
...
_슬라이드 16: Alice-Bob 채널 timeout_
...
_슬라이드 20: Alice의 Commitment Tx 구조_
...
_슬라이드 21: HTLC-timeout Transaction_
...
_슬라이드 22: Bob의 Commitment Tx 구조_
...
_슬라이드 23: HTLC-success Transaction_
...
_슬라이드 26: 실제 Bitcoin Script 코드_
...
을 만들어낸 것이 바로 **HTLC**입니다.

라이트닝 네트워크의 가장 아름다운 부분도  
바로 이런 설계라고 생각합니다.
