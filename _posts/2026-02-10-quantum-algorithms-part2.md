...
description: "양자컴퓨터 입문 #2 – 양자 알고리즘: Shor의 지수적 가속으로 RSA 위협, Grover의 2차 가속으로 탐색 최적화"
image:
...
[지난 포스트]({% post_url 2026-02-09-quantum-computing-basics-part1 %})에서 큐비트의 **중첩**, **얽힘**, **간섭**이 왜 강력한지 배웠습니다. 이제 진짜 궁금한 건 이거죠:
